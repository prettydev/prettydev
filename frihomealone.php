...
<title>Home Alone - Christmas Drive-in Manchester 2018</title>
...
<header id="myCarousel" class="carousel slide innercarouselheight"> 
  ...
  <div class="carousel-inner agile2">
    <div class="item active">
      <div class="fill" style="background-image:url('images/homealonebanner.jpg');"></div>
      <div class="carousel-caption innercarousel-caption">
        <h2 class="font-me" style="font-weight:bold;">Home Alone</h2>
        <p class="font-crimson-body-text-white"><span style="font-weight:bold;">21st December - 9.30 PM</span></p>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Home Alone", "time"=>"9.30 PM", "address"=>"AJ Bell Stadium, 1 Stadium Way, Barton-Upon-Irwell, Salford M30 7EY", "dates" => "21st December", "img"=>"images/l1.jpg")
          ...
          <div class="pad-left40 ">
            ...
            <div class="session-content" style="font-size:20px; line-height:30px;">
              ...
              <p>AJ Bell Stadium <br>
                ...
                (sat nav M30 7LJ)
              <p>
              <p><strong>Movie Start Time:</strong> 9.30PM<br>
                <strong>Gates Open:</strong> 8.30PM</p>
