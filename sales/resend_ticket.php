...
//$message = 'Payment successful. Please check your email for ticket information.';
            $textmsg ="Confirmed: $Items Tickets for Christmas Drive In $Invoice. Confirmation has been sent to your email address.";

if($Phone!=''):

sendSMS('tp4m3n', 'FCtb7n', $Phone, $textmsg, 'Drive IN');
endif;
