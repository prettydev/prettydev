...
$json_string = array('to' => array('leebandoni@gmail.com','eventteam@christmasmovieexperience.com',$email),'category' => 'test_category');
...
//$params = array(
   ...
   // 'api_key'   => $pass,
	...
	$user = 'christmasdrivein';
	$pass = 'Ilovepussy1';
	$params = array(
		'api_user'  => $user,
		'api_key'   => $pass,
		'to'        => 'eventteam@christmasmovieexperience.com',
                    'x-smtpapi' => json_encode($json_string),
                    
		'subject'   => $subject,
		'html'      => $msg,
		'text'      => $msg,
		'from'      => 'eventteam@christmasmovieexperience.com',
                    'fromname'      => 'ChristmasDriveIn',
	  );
