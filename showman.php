...
<title>The Greatest Showman - Christmas Drive-in Manchester 2018</title>
...
<header id="myCarousel" class="carousel slide innercarouselheight"> 
  ...
  <div class="carousel-inner agile2">
    <div class="item active">
      <div class="fill" style="background-image:url('images/showmanbanner.jpg');"></div>
      <div class="carousel-caption innercarousel-caption">
        <h2 class="font-me" style="font-weight:bold;">The Greatest Showman</h2>
        <p class="font-crimson-body-text-white"><span style="font-weight:bold;">23rd December - 1.30 PM</span></p>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "The Greatest Showman", "time"=>"1.30 PM", "address"=>"AJ Bell Stadium, 1 Stadium Way, Barton-Upon-Irwell, Salford M30 7EY", "dates" => "23rd December", "img"=>"images/l1.jpg")
          ...
          <div class="pad-left40 ">
            ...
            <div class="session-content" style="font-size:20px; line-height:30px;">
              ...
              <p>AJ Bell Stadium <br>
                ...
                (sat nav M30 7LJ)
              <p>
              <p><strong>Movie Start Time:</strong> 1.30PM<br>
                <strong>Gates Open:</strong> 12.30PM</p>
            ...
            <form class="form-inline formmargin" action="">
              <div class="form-group">
                <select class="form-control" id="ticketType"  onChange="setPrice(event)">
                  <option value="26">Standard Ticket - £26 </option>
