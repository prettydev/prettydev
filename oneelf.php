  ...
  <div class="carousel-inner agile2">
    <div class="item active">
      ...
      <div class="carousel-caption innercarousel-caption">
        ...
        <p class="font-crimson-body-text-white"><span style="font-weight:bold;">22nd December - 8.00 PM</span></p>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Elf", "time"=>"8.00 PM", "address"=>"AJ Bell Stadium, 1 Stadium Way, Barton-Upon-Irwell, Salford M30 7EY", "dates" => "22nd December", "img"=>"images/l1.jpg")
          ...
          <div class="pad-left40 ">
            ...
            <div class="session-content" style="font-size:20px; line-height:30px;">
              ...
              <p>AJ Bell Stadium <br>
                ...
                (sat nav M30 7LJ)
              <p>
              <p><strong>Movie Start Time:</strong> 8.00PM<br>
                <strong>Gates Open:</strong> 6.30PM</p>
