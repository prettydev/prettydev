...
<head>
    ...
    <title>Hocus Pocus - Horror Night Screening Glasgow</title>
    ...
    <header id="myCarousel" class="carousel slide innercarouselheight">
        ...
        <div class="carousel-inner agile2">
            <div class="item active">
                <div class="fill" style="background-image:url('images/hocus.jpg');"></div>
                <div class="carousel-caption innercarousel-caption">
                    <h2 class="font-me">Hocus Pocus</h2>
               ...
               <p class="font-crimson-body-text-white"><span>27th October - 1.30 PM</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container" id="festival1">
        ...
        <div class="row">
           ...
           <div class="col-md-9">
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Hocus Pocus", "time"=>"1.30 PM", "address"=>"23 Clydebrae Street Glasgow G51 2AJ", "dates" => "27th October", "img"=>"images/l1.jpg")
                   ...
                   <div class="row sessionticket">
                       <div class="col-md-12 col-sm-12 ">
                           <div class="pad-left40 ">
                               ...
                               <p>This Daytime Showing is Family Friendly With A Not So Scary Haunted Maze </p>
          ...
          <div class="col-md-3">
            ...
            <li  class="font-crimson-body-text-black mar-top-20 bold-text">Doors Open - 1PM</li>
            <li  class="font-crimson-body-text-black bold-text">Certification - PG</li>
