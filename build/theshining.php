...
<head>
    ...
    <title>The Shining - Horror Night Screening Glasgow</title>
    ...
    <header id="myCarousel" class="carousel slide innercarouselheight">
        ...
        <div class="carousel-inner agile2">
            <div class="item active">
                <div class="fill" style="background-image:url('images/shinings.jpg');"></div>
                <div class="carousel-caption innercarousel-caption">
                    <h2 class="font-me">The Shining</h2>
               ...
               <p class="font-crimson-body-text-white"><span>25th October - 6.30 PM</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container" id="festival1">
        ...
        <div class="row">
           ...
           <div class="col-md-9">
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "The Shining", "time"=>"6.30 PM", "address"=>"23 Clydebrae Street Glasgow G51 2AJ", "dates" => "25th October", "img"=>"images/l1.jpg")
