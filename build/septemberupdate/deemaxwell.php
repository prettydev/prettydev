...
<head>
    ...
    <title>Dee Maxwell - Live In Glasgow</title>
    ...
    <header id="myCarousel" class="carousel slide innercarouselheight">
        ...
        <div class="carousel-inner agile2">
            <div class="item active">
                <div class="fill" style="background-image:url('images/deemaxwell.jpg');"></div>
                <div class="carousel-caption innercarousel-caption">
                    <h2 class="font-me">Dee Maxwell - Live In Glasgow</h2>
               ...
               <p class="font-crimson-body-text-white"><span>25th October - 7.30 PM</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container" id="festival1">
        ...
        <div class="row">
           ...
           <div class="col-md-9">
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Dee Maxwell - Live In Glasgow", "time"=>"7.30 PM", "address"=>"23 Clydebrae Street Glasgow G51 2AJ", "dates" => "25th October", "img"=>"images/l1.jpg")
                   ...
                   <div class="row sessionticket">
                       <div class="col-md-12 col-sm-12 ">
                           <div class="pad-left40 ">
                               ...
                               <p>Scottish Comedy sensation Dee Maxwell will be bringing her sell out show to Glasgow Horror Nights for an evening of Crazy Halloween fun with special guests and a party DJ.</p>
                               <p>Dee’s outrageous performance will have you dying of laughter but we must warn you that no subject is off limits and mayhem is guaranteed as she recalls growing up in the toughest part of Kilbirnie.</p>
                               <p>With almost 50 thousand Facebook Fans Dee has became one of the UK’s fastest growing comedians and is often compared to Kevin Bridges or Billy Connolly cementing her as one of Scotland’s finest exports next to Buckfast!</p>
          ...
          <div class="col-md-3">
            ...
            <li  class="font-crimson-body-text-black">Comedy Performance</li>
            ...
            <li  class="font-crimson-body-text-black bold-text">Entry - 18+</li>
