...
<head>
    ...
    <title>Nightmare On Elm Street - Glasgow Horror Cinema</title>
    ...
    <header id="myCarousel" class="carousel slide innercarouselheight">
        ...
        <div class="carousel-inner agile2">
            <div class="item active">
                <div class="fill" style="background-image:url('images/fredd.jpg');"></div>
                <div class="carousel-caption innercarousel-caption">
                    <h2 class="font-me">Nightmare On Elm Street</h2>
               ...
               <p class="font-crimson-body-text-white"><span>25th October - 9.30 PM</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container" id="festival1">
        ...
        <div class="row">
           ...
           <div class="col-md-9">
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Nightmare On Elm Street", "time"=>"9.30 PM", "address"=>"23 Clydebrae Street Glasgow G51 2AJ", "dates" => "25th October", "img"=>"images/l1.jpg")
                       ...
                       <div class="col-md-12 col-sm-12">
                           <div class="pad-left40">
                               <form class="form-inline formmargin" action="">
                                   ...
                                   <button data-price="1" data-time="<?php echo $ticket["time"]; ?>" data-dates="<?php echo $ticket["dates"]; ?>" data-location="<?php echo $ticket["location"]; ?>" data-address="<?php echo $ticket["address"]; ?>" data-toggle="modal" data-target="#exampleModalLong" onclick="buyTicket(event)" class="btn btn-default buyticket">Buy Tickets</button>
                               </form>
                           </div>
                       </div>
                   </div>
          ...
          <div class="col-md-3">
            ...
            <li  class="font-crimson-body-text-black mar-top-20 bold-text">Doors Open - 9PM</li>
