    ...
    <header id="myCarousel" class="carousel slide innercarouselheight">
        ...
        <div class="carousel-inner agile2">
            <div class="item active">
               ...
               <p class="font-crimson-body-text-white"><span>27th October - 6.30 PM</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container" id="festival1">
        ...
        <div class="row">
           ...
           <div class="col-md-9">
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Ghostbusters", "time"=>"6.30 PM", "address"=>"23 Clydebrae Street Glasgow G51 2AJ", "dates" => "27th October", "img"=>"images/l1.jpg")
