...
<head>
    ...
    <title>The Conjuring 2 - Horror Night Screening Glasgow</title>
        ...
        <div class="carousel-inner agile2">
            <div class="item active">
                ...
                <div class="carousel-caption innercarousel-caption">
                    <h2 class="font-me">The Conjuring Two</h2>
               <!-- <p class="font-crimson-body-text-white"><span><i class="fa fa-map-marker" aria-hidden="true"></i></span></p> -->
               <p class="font-crimson-body-text-white"><span>26th October - 9.30 PM</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container" id="festival1">
        ...
        <div class="row">
           ...
           <div class="col-md-9">
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "The Conjuring Two", "time"=>"9.30 PM", "address"=>"23 Clydebrae Street Glasgow G51 2AJ", "dates" => "26th October", "img"=>"images/l1.jpg")
