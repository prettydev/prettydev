            ...
            <form class="form-inline formmargin" action="">
              <div class="form-group">
                <select class="form-control" id="ticketType"  onChange="setPrice(event)">
                  ...
                  <option value="2">Ticket - £26 </option>
                </select>
              </div>
              <div class="form-group">
...
<div id="footer">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 text-center"><a href="#tos" data-toggle="modal">Terms and conditions</a><p>2018 Christmas Drive-In™ is used under licence from Z100 Entertainment Inc</p></div>
