    ...
    <header id="myCarousel" class="carousel slide innercarouselheight">
        ...
        <div class="carousel-inner agile2">
            <div class="item active">
               ...
               <p class="font-crimson-body-text-white"><span><i class="fa fa-clock-o" aria-hidden="true"></span></i>3rd November 2018</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container" id="festival1">
        ...
        <div class="row">
           ...
           <div class="col-md-9 font-me">
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Afternoon Session", "time"=>"12.30PM to 05.30PM", "address"=>"Crypt Hall - Mount Pleasant Liverpool L3 5TQ", "dates" => "3rd November", "img"=>"images/l1.jpg"),

                   array("location" => "Evening Session", "time"=>"06.30PM to 17:30PM", "address"=>"Crypt Hall - Mount Pleasant Liverpool L3 5TQ", "dates" => "3rd November", "img"=>"images/l2.jpg"),
...
<li  class="font-crimson-body-text-black">Festival Access</li>
      ...
      <!-- ticketsection -->
      <section class="map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2347.2774133375574!2d-2.0181421841382274!3d53.962341280112774!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487bf395c99ee469%3A0x1d9d7538063806d9!2sSkipton+Town+Hall!5e0!3m2!1sen!2suk!4v1522161567680" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
      </section>
...
<div class="col-md-4">
         ...
         <a class="btn socialbtnfooter social-facebook" href="https://www.facebook.com/VivaProseccoFestival/"><i class="fa fa-facebook"></i></a>
         <a class="btn socialbtnfooter social-facebook" href="https://www.instagram.com/vivaproseccofestival/"><i class="fa fa-instagram"></i></a>
         <a class="btn socialbtnfooter social-facebook" href="https://twitter.com/VivaProsecco"><i class="fa fa-twitter"></i></a>
         </div>
      </div>
      <div class="col-md-4">
