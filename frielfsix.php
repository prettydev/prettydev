  ...
  <div class="carousel-inner agile2">
    <div class="item active">
      ...
      <div class="carousel-caption innercarousel-caption">
        ...
        <p class="font-crimson-body-text-white"><span style="font-weight:bold;">21st December - 6.00 PM</span></p>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Elf", "time"=>"6.00 PM", "address"=>"AJ Bell Stadium, 1 Stadium Way, Barton-Upon-Irwell, Salford M30 7EY", "dates" => "21st December", "img"=>"images/l1.jpg")
