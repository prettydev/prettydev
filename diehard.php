...
<title>Die Hard - Christmas Drive-in Manchester 2018</title>
...
<header id="myCarousel" class="carousel slide innercarouselheight"> 
  ...
  <div class="carousel-inner agile2">
    <div class="item active">
      <div class="fill" style="background-image:url('images/diehardbanner.jpg');"></div>
      <div class="carousel-caption innercarousel-caption">
        <h2 class="font-me" style="font-weight:bold;">Die Hard</h2>
        <p class="font-crimson-body-text-white"><span style="font-weight:bold;">23rd December - 9.30 PM</span></p>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Die Hard", "time"=>"9.30 PM", "address"=>"AJ Bell Stadium, 1 Stadium Way, Barton-Upon-Irwell, Salford M30 7EY", "dates" => "23rd December", "img"=>"images/l1.jpg")
