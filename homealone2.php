...
<title>Home Alone 2 - Christmas Drive-in Manchester 2018</title>
...
<header id="myCarousel" class="carousel slide innercarouselheight"> 
  ...
  <div class="carousel-inner agile2">
    <div class="item active">
      <div class="fill" style="background-image:url('images/homealone2banner.jpg');"></div>
      <div class="carousel-caption innercarousel-caption">
        <h2 class="font-me" style="font-weight:bold;">Home Alone 2</h2>
        <p class="font-crimson-body-text-white"><span style="font-weight:bold;">20th November - 1.30 PM</span></p>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php
               ...
               // kdaviesnz
               $tickets = array(
                  array("location" => "Home Alone 2", "time"=>"1.30 PM", "address"=>"AJ Bell Stadium, 1 Stadium Way, Barton-Upon-Irwell, Salford M30 7EY", "dates" => "20th December", "img"=>"images/l1.jpg")
